...
# renamed.
-keep class space.linuxct.glyphworks.key.EssentialKeyService { *; }
-keep class space.linuxct.glyphworks.key.KeyCaptureTileService { *; }
-keep class space.linuxct.glyphworks.toy.AodToyService { *; }
-keep class space.linuxct.glyphworks.toy.TimerAlarmReceiver { *; }
...
-keepclassmembers class space.linuxct.glyphworks.util.AndroidPrefs {
