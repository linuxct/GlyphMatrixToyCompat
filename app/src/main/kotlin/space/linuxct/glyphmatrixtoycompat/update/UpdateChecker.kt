package space.linuxct.glyphmatrixtoycompat.update
...
object UpdateChecker {
    ...
    const val RELEASES_PAGE = "https://github.com/linuxct/GlyphMatrixToyCompat/releases/latest"
    private const val LATEST_API = "https://api.github.com/repos/linuxct/GlyphMatrixToyCompat/releases/latest"
    ...
    fun check(installedVersion: String): Result {
        ...
        return try {
            ...
            conn.setRequestProperty("User-Agent", "GlyphMatrixToyCompat")
